...
<style>
    ...
    .s--inner button:focus {
        outline: var(--switch-accent-color) solid 1px;
    }
    ...
    .s--slider button:focus {
        box-shadow: 0 0px 0px 1px var(--switch-accent-color);
    }
    ...
    .s--multi:focus-within label:first-of-type:after {
        box-shadow: 0 0px 8px var(--switch-accent-color);
        border-radius: 1.5em;
    }
    ...
    .s--multi label:first-of-type:after {
        background: var(--switch-accent-color);
        border-radius: 1em;
        margin: 0 1em;
